...
const LendingCard = props => {
   const { id, firstName, lastName, phoneNumber, debt, date, deleteDebt, editDebt } = props;
   return (
      <div className='user'>
         <div className='user-top p-3 d-flex justify-content-between align-items-center'>
            ...
            <div className='btns'>
               ...
               <button className='btn btn-outline-warning mx-3' onClick={() => editDebt( id )}>E</button>
               <button className='btn btn-outline-danger' onClick={() => deleteDebt( id )}>D</button>
            </div>
         </div>
